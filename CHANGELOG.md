...
### Removed
- `CheckboxStackedCards` and `RadioStackedCards` components and `ComponentStyles::StackedCards`.
- `CheckboxTable` and `RadioTable` components and `ComponentStyles::Table`.
